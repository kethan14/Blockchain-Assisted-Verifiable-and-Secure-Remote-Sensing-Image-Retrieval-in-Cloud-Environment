...
insert  into `owner`(`username`,`password`,`email`,`gender`,`address`,`mobile`,`skey`,`status`) values ('kethan','kethan','kethan.kanithi@gmail.com','male','moosapet\r\nnear 99-pharm','7013254002','28033','sent');
...
insert  into `request`(`id`,`filename`,`email`,`owner`,`cat`,`skey`,`hkey`,`status`,`cloud`) values (8,'new.jpg','vinay123@gmail.com','shiva','Developer','NXPouRZI/wuRgqz4VHMSJg==','-1805144964','pending','Verified');
...
insert  into `upload`(`filename`,`cat`,`owner`,`skey`,`hkey`) values ('new.jpg','Developer','kethan','NXPouRZI/wuRgqz4VHMSJg==','-1805144964');
...
insert  into `user`(`username`,`password`,`email`,`gender`,`address`,`mobile`,`status`,`cat`) values ('vinay','vinay','vinay123@gmail.com','MALE','hyd','08121893257','waiting','Developer');
